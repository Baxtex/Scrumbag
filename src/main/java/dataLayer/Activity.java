...
public class Activity {
	...
	private String elementId, projectId, sprintId, title, description, respUser, status, priority;
	private int timeExpectedHH, timeExpectedMM, timeSpentHH, timeSpentMM;
