...
/**
 * This class is a stub(!) representing an actual database with two tables
 * represented as hash tables.
 * 
 * 1. Users table (primary key is username) | username | password | authority |
 * 
 * 2. Sessions table (primary key is key) | key | timestamp | authority |
 * 
 *
 */

// TODO Constructor is only for testing purposes. May be removed later.
public class SecurityDB {
	...
	/**
	 * Returns the authority of the user matching the user name, -1 if there is
	 * none.
	 */
	...
	/**
	 * Creates a new user and stores in "database", if the user name is not
	 * taken.
	 */
