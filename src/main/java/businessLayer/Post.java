...
public class Post {
	...
	/**
	 * Creates a new sprint and returns a JSONObject with sprint id, or error information.
	 * @param projectId 
	 * @param title 
	 * @param index 
	 * @param res
	...
	/**
	 * Creates a new activity and returns a JSONObject with activity id, or error information.
	 * @param projectId
	 * @param sprintId
	 * @param title
	 * @param description
	...
	public JSONObject createActivity(String projectId, String sprintId, String title, String description, String timeExpected, String timeSpent, String respUser, String status, String priority, Response res) {		
		if(!dataHandler.checkProjectId(projectId)) {
